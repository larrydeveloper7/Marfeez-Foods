    ...
    <footer className="bg-[#1b1a18] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          >
            ...
            <p className="mt-4 text-white max-w-md">
              ...
              We bring you the most delicious dishes made with fresh, locally sourced ingredients.
            </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 pt-8 border-t border-[#383633]"
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-center md:text-right">
              <p className="text-sm text-white">
                © {currentYear} Marfeez Bites. All rights reserved.
              </p>
